...
export const LEVELS = [
  {
    ...
    maxTargets: 3,
    spawnInterval: 2500,
    targetWeights: { normal: 80, fast: 10, small: 5, bonus: 5 },
  ...
  },
  {
    ...
    maxTargets: 5,
    spawnInterval: 1500,
    targetWeights: { normal: 20, fast: 60, small: 10, bonus: 10 },
  ...
  },
  {
    ...
    maxTargets: 4,
    spawnInterval: 2000,
    targetWeights: { normal: 10, fast: 10, small: 70, bonus: 10 },
  ...
  },
  {
    ...
    maxTargets: 6,
    spawnInterval: 1200,
    targetWeights: { normal: 30, fast: 15, small: 15, bonus: 40 },
  ...
  },
  {
    ...
    maxTargets: 5,
    spawnInterval: 1000,
    targetWeights: { normal: 40, fast: 30, small: 20, bonus: 10 },
  ...
  },
  {
    ...
    maxTargets: 6,
    spawnInterval: 1400,
    targetWeights: { normal: 30, fast: 25, small: 25, bonus: 20 },
  ...
  },
  {
    ...
    maxTargets: 5,
    spawnInterval: 1800,
    targetWeights: { normal: 40, fast: 20, small: 20, bonus: 20 },
    movementWeights: { linear: 40, sine: 30, random: 20, static: 10 },
  ...
  },
  {
    ...
    maxTargets: 6,
    spawnInterval: 1300,
    targetWeights: { normal: 35, fast: 35, small: 20, bonus: 10 },
  ...
  },
  {
    ...
    maxTargets: 5,
    spawnInterval: 1500,
    targetWeights: { normal: 25, fast: 25, small: 30, bonus: 20 },
  ...
  },
  {
    ...
    maxTargets: 8,
    spawnInterval: 800,
    targetWeights: { normal: 25, fast: 25, small: 25, bonus: 25 },
